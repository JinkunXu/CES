...
def main():
    ...
    ap.add_argument("--out_log", type=str, default="runs/flask/CES.jsonl")
    ap.add_argument("--cache", type=str, default="runs/flask/cache_CES.jsonl")
    ...
    with open(args.out_log, "w", encoding="utf-8") as wf:
        ...
        for t, (prompt, raw) in enumerate(tqdm(it, total=args.limit if args.limit else None)):
            ...
            scoress.append(score); costs.append(actual_cost_usd); rewards.append(reward)
